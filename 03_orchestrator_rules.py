            ...
            "retail": [
                {
                    ...
                    "operation"  : "multiply",
                    "value"      : 0.85,
                    "description": "Tahan reorder_request ke 85% untuk mengurangi tekanan ke upstream",
                },
            ],
        },
    },
            ...
            "retail": [
                {
                    ...
                    "operation"  : "multiply",
                    "value"      : 0.80,
                    "description": "Kurangi reorder_request ke 80% untuk mengurangi beban Wholesaler",
                },
            ],
        },
    },
            ...
            "retail": [
                {
                    ...
                    "description": "Naikkan reorder_request 20% jika stok di bawah safety_stock",
                },
                {
            ...
            "retail": [
                {
                    ...
                    "operation"  : "multiply",
                    "value"      : 0.90,
                    "condition"  : "reorder_request > demand_estimate * 1.2",
                    "description": "Reset reorder_request ke 90% jika melebihi 120% demand_estimate",
                },
                {
                    "variable"   : "safety_stock",
                    "operation"  : "multiply",
            ...
            "retail": [
                {
                    ...
                    "value"      : 1.15,
                    "condition"  : "retail_inventory < safety_stock",
                    "description": "Naikkan reorder_request 15% jika stok di bawah safety_stock",
                },
                {
                    "variable"   : "demand_estimate",
                    "operation"  : "multiply",
            ...
            "retail": [
                {
                    ...
                    "description": "Naikkan reorder_request 30% jika stok < 50% safety_stock",
                },
                {
                    "variable"   : "safety_stock",
                    "operation"  : "multiply",
            ...
            "retail": [
                {
                    ...
                    "value"      : 1.25,
                    "condition"  : "retail_inventory < safety_stock",
                    "description": "Naikkan reorder_request 25% jika di bawah safety_stock",
                },
                {
            ...
            "retail": [
                {
                    ...
                    "value"      : 1.20,
                    "condition"  : "retail_inventory < safety_stock",
                    "description": "Naikkan reorder_request 20% darurat",
                },
                {
                    "variable"   : "safety_stock",
                    "operation"  : "multiply",
