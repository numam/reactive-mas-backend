    ...
    "farm": {
        ...
        "onset": [
            ...
            },
            {
                ...
                "description" : "IF mortality_rate > 6% → indikasi wabah penyakit",
            },
            {
                "condition_id": "FAR-T3",
                "variable"    : "feed_stock",
            ...
            {
                "condition_id": "FAR-T5",
                "variable"    : "growth_status",
                "operator"    : "==",
                "threshold"   : "stunted",
                "event_type"  : "GROWTH_STUNTED",
                "description" : "IF growth_status == stunted → pertumbuhan terhambat parah",
            },
        ],
        "recovery": [
            {
...
def _compare(val, operator, threshold):
    try:
        ...
        elif operator == "==" : return str(val)   == str(threshold)
        elif operator == "!=" : return str(val)   != str(threshold)
